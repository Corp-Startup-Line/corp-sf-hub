  ...
  return (
    <section className="rounded-3xl border border-white/50 bg-gradient-to-b from-white/70 to-white/35 p-8 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_12px_34px_-14px_rgba(0,0,0,0.22)] backdrop-blur-2xl backdrop-saturate-150 dark:border-white/[0.12] dark:from-white/[0.10] dark:to-white/[0.03] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.10),0_12px_34px_-14px_rgba(0,0,0,0.55)]">
      ...
      <ul className="mt-6 divide-y divide-black/[0.06] dark:divide-white/10">
        {duties.map((d) => (
          <li key={d.title} className="flex gap-4 py-4 first:pt-0 last:pb-0">
            <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-corgi-ginger/10 text-corgi-ginger">
              {d.icon}
            </span>
            <div>
